...
The source code is licensed under the [MIT License](./LICENSE). The vizarr logo and artwork in the [`assets/`](./assets) directory are licensed under [CC-BY-4.0](./assets/LICENSE).
