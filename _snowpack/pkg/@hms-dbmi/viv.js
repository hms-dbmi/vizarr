...
function interpolateQuad(quad, ut, vt) {
  return lerp$2(lerp$2(quad[0], quad[1], vt), lerp$2(quad[3], quad[2], vt), ut);
}
...
var BitmapLayer = function (_Layer) {
  ...
  var _super = _createSuper$2(BitmapLayer);
...
var ScatterplotLayer = function (_Layer) {
  ...
  var _super = _createSuper$3(ScatterplotLayer);
...
ScatterplotLayer.defaultProps = defaultProps$1;
...
var PathTesselator = function (_Tesselator) {
  ...
  var _super = _createSuper$4(PathTesselator);

  function PathTesselator(opts) {
    _classCallCheck(this, PathTesselator);

    return _super.call(this, _objectSpread$2(_objectSpread$2({}, opts), {}, {
      attributes: {
        positions: {
          size: 3,
          padding: 18,
...
var PathLayer = function (_Layer) {
  ...
  var _super = _createSuper$5(PathLayer);
...
PathLayer.defaultProps = defaultProps$2;
...
function getPropertiesForIndex(data, propertiesIndex, numericPropsIndex) {
  var feature = {
    properties: _objectSpread$3({}, data.properties[propertiesIndex])
  };
...
function createLayerPropsFromBinary(geojsonBinary, uniqueIdProperty, encodePickingColor) {
  ...
  var customPickingColors = calculatePickingColors(geojsonBinary, uniqueIdProperty);
...
var GeoJsonLayer = function (_CompositeLayer) {
  ...
  var _super = _createSuper$6(GeoJsonLayer);
  ...
  _createClass(GeoJsonLayer, [{
    ...
    value: function renderLayers() {
      ...
      }), _objectSpread$4(_objectSpread$4({}, layerProps.points), {}, {
...
function getTileIndices(_ref) {
  var viewport = _ref.viewport,
      ...
      tileSize = _ref$tileSize === void 0 ? TILE_SIZE$1 : _ref$tileSize,
...
var Tileset2D = function () {
  ...
  _createClass(Tileset2D, [{
    ...
    value: function updateTileStates() {
      ...
      var _iterator2 = _createForOfIteratorHelper$4(this._cache.values()),
          _step2;
    ...
    value: function _updateTileStates(selectedTiles) {
      ...
      var _iterator5 = _createForOfIteratorHelper$4(_cache.values()),
          _step5;
      ...
      var _iterator8 = _createForOfIteratorHelper$4(selectedTiles),
          _step8;
    ...
    value: function _resizeCache() {
      ...
      if (overflown) {
        var _iterator9 = _createForOfIteratorHelper$4(_cache),
            _step9;
...
function getPlaceholderInChildren(tile) {
  var _iterator10 = _createForOfIteratorHelper$4(tile.children),
      _step10;
...
var defaultProps$4 = {
  ...
  fetch: {
    ...
    value: function value(url, _ref) {
      ...
      var loadOptions = _objectSpread$7({
        signal: signal
...
var TileLayer = function (_CompositeLayer) {
  ...
  var _super = _createSuper$7(TileLayer);
...
TileLayer.defaultProps = defaultProps$4;
...
class ZarrPixelSource {
  ...
  get dtype() {
    ...
    if (!(suffix in DTYPE_LOOKUP$1)) {
      throw Error(`Zarr dtype not supported, got ${suffix}.`);
    }
    return DTYPE_LOOKUP$1[suffix];
  }
...
export { DTYPE_VALUES, ImageLayer, MultiscaleImageLayer, XRLayer, ZarrPixelSource };
