...
var Vector = function (_MathArray) {
  ...
  var _super = _createSuper$b(Vector);
  ...
  _createClass(Vector, [{
    ...
    value: function getComponent(i) {
      assert$7(i >= 0 && i < this.ELEMENTS, 'index is out of range');
...
var Vector3 = function (_Vector) {
  ...
  var _super = _createSuper$c(Vector3);
  ...
  function Vector3() {
    ...
    if (arguments.length === 1 && isArray$2(x)) {
      _this.copy(x);
    } else {
      if (config.debug) {
        checkNumber(x);
...
function calculateMatrixAndOffset(viewport, coordinateSystem, coordinateOrigin) {
  ...
  if (offsetMode) {
    ...
    projectionCenter = transformMat4$1([], positionCommonSpace, viewProjectionMatrix);
...
function lngLatToWorld(_ref) {
  ...
  assert$6(Number.isFinite(lng));
  assert$6(Number.isFinite(lat) && lat >= -90 && lat <= 90, 'invalid latitude');
...
function getMeterZoom(_ref5) {
  ...
  assert$6(Number.isFinite(latitude));
...
function getDistanceScales(_ref6) {
  ...
  assert$6(Number.isFinite(latitude) && Number.isFinite(longitude));
  var result = {};
...
function worldToPixels(xyz, pixelProjectionMatrix) {
  ...
  assert$6(Number.isFinite(x) && Number.isFinite(y) && Number.isFinite(z));
...
function pixelsToWorld(xyz, pixelUnprojectionMatrix) {
  ...
  assert$6(Number.isFinite(x) && Number.isFinite(y), 'invalid pixel coordinate');
...
function fitBounds(_ref) {
  ...
  if (Number.isFinite(padding)) {
    ...
    assert$6(Number.isFinite(padding.top) && Number.isFinite(padding.bottom) && Number.isFinite(padding.left) && Number.isFinite(padding.right));
  }
...
var WebMercatorViewport$1 = function (_Viewport) {
  ...
  var _super = _createSuper$d(WebMercatorViewport);
...
function getWorldPosition(position, _ref) {
  ...
  if (modelMatrix) {
    var _vec4$transformMat = transformMat4$1([], [x, y, z, 1.0], modelMatrix);
...
var Attribute = function (_DataColumn) {
  ...
  var _super = _createSuper$e(Attribute);
  ...
  _createClass(Attribute, [{
    ...
    value: function allocate(numInstances) {
      ...
      if (settings.update) {
        assert$5(Number.isFinite(numInstances));
...
var CPUInterpolationTransition = function (_Transition) {
  ...
  var _super = _createSuper$f(CPUInterpolationTransition);
...
var CPUSpringTransition = function (_Transition) {
  ...
  var _super = _createSuper$g(CPUSpringTransition);
...
var LayerState = function (_ComponentState) {
  ...
  var _super = _createSuper$h(LayerState);
...
var Layer = function (_Component) {
  ...
  var _super = _createSuper$i(Layer);
  ...
  _createClass(Layer, [{
    ...
    value: function _initState() {
      assert$5(!this.internalState && !this.state);
      assert$5(isFinite(this.props.coordinateSystem), "".concat(this.id, ": invalid coordinateSystem"));
...
export { cssToDeviceRatio as $, log$1 as A, Buffer as B, COORDINATE_SYSTEM as C, instrumentGLContext as D, isWebGL as E, FEATURES as F, resetParameters as G, resizeGLContext as H, Framebuffer as I, lumaStats as J, createGLContext as K, Layer as L, Model as M, mod as N, memoize as O, PROJECTION_MODE as P, pixelsToWorld as Q, Resource as R, Stats as S, Transition as T, ProgramManager as U, Vector as V, WebMercatorViewport as W, setParameters as X, withParameters as Y, clear as Z, _get as _, Viewport as a, Renderbuffer as a0, LIFECYCLE as a1, WebMercatorViewport$1 as a2, cssToDevicePixels as a3, readPixelsToArray as a4, EVENTS as a5, assert$5 as b, Texture2D as c, debug as d, cloneTextureFrom as e, flatten as f, copyToTexture as g, createIterable as h, log as i, assert$3 as j, getAccessorFromBuffer as k, load as l, mod$1 as m, defaultTypedArrayManager as n, hasFeatures as o, getUniformsFromViewport as p, _asyncToGenerator as q, regenerator as r, lngLatToWorld as s, Vector3 as t, uid as u, isWebGL2 as v, hasFeature as w, env$1 as x, register as y, registerLoaders as z };
