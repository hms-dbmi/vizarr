...
import { j as assert, u as uid, b as assert$1, k as getAccessorFromBuffer, h as createIterable, B as Buffer, n as defaultTypedArrayManager, _ as _get, C as COORDINATE_SYSTEM, o as hasFeatures, M as Model, L as Layer, F as FEATURES } from './layer-3339c0fa.js';
...
import { p as project } from './project-c0678e19.js';
  ...
  _createClass(Tesselator, [{
    ...
    value: function updateGeometry(opts) {
      ...
      if (Array.isArray(dataChanged)) {
        var _iterator = _createForOfIteratorHelper$1(dataChanged),
            _step;
    ...
    value: function _forEachGeometry(visitor, startRow, endRow) {
      ...
      var _iterator2 = _createForOfIteratorHelper$1(iterable),
          _step2;
...
function forEachSegmentInPolygon(points, visitor) {
  ...
  var isClosedEx = isClosed || equals$1(points[start], points[endPointIndex]) && equals$1(points[start + 1], points[endPointIndex + 1]);
...
function forEachSegmentInPolygonPoints(points, visitor) {
  ...
  var isClosedEx = isClosed || equals$1(points[end - 1], points[0]);
...
function cutPolylineByMercatorBounds(positions) {
  ...
  if (normalize) {
    var _iterator = _createForOfIteratorHelper$2(parts),
        _step;
...
function cutPolygonByMercatorBounds(positions, holeIndices) {
  ...
  if (normalize) {
    var _iterator2 = _createForOfIteratorHelper$2(parts),
        _step2;
...
function normalize(polygon, positionSize) {
  ...
  if (!isSimple(polygon)) {
    ...
    var _iterator = _createForOfIteratorHelper$3(polygon.entries()),
        _step;
  ...
  _createClass(PolygonTesselator, [{
    ...
    value: function getGeometrySize(polygon) {
      if (Array.isArray(polygon) && !Number.isFinite(polygon[0])) {
        ...
        var _iterator = _createForOfIteratorHelper$4(polygon),
            _step;
    ...
    value: function updateGeometryAttributes(polygon, context) {
      if (Array.isArray(polygon) && !Number.isFinite(polygon[0])) {
        var _iterator2 = _createForOfIteratorHelper$4(polygon),
            _step2;
